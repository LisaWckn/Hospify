...
export class DummyMethods {
  ...
  static emptyPatient: Patient = {patientenID: -1, plz:0, name: "", geschlecht: "", blutgruppe: "", geburtsdatum: new Date(), adresse: "", kontakttelefon: "", verstorben: false, krankenversicherungsnummer: "", gewicht: 0, krankenkassenstatus: ""};
